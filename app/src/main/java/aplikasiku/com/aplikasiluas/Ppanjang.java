...
public class Ppanjang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ppanjang);
        alas = (EditText)findViewById(R.id.Panjangpp);
        tinggi = (EditText) findViewById(R.id.Lebarpp);
        hitung = (Button) findViewById(R.id.Hitungpp);
        luas = (TextView) findViewById(R.id.Luaspp);
